...
\DeclareMathOperator{\mdeg}{m\partial}
...
\fancyhead[R]{ \textsc{Teoria de cuerpos 2025-I}\\ \small \textit{Taller 4}} 
...
{ \vspace{1em}\noindent\begin{tabular}{|p{0.9\linewidth}|}\hline }
{\\\hline\end{tabular}\vspace{1em}}
