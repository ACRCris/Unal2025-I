...
Comenzamos con la siguiente inquietud: \textbf{Es la funcion identidad} \( id: (\mathbb{R}, \mathscr{T}_t) \to (\mathbb{R}, \mathscr{T}_u)  \) \textbf{continua?} \\ \\
La respuesta es \textbf{no}. Consideremos \( (0,1) \in (\mathbb{R}, \mathscr{T}_u \), abierto en el conjunto de llegada. Observe que \( id^{-1}((0,1))=(0,1) \notin \mathscr{T}_t \). \\ \\
\textbf{\underline{Observacion}:} Dado un conjunto \(X\) y \( \mathscr{T}_1, \mathscr{T}_2 \) topologias en \(X\). \( id: (X, \mathscr{T}_1) \to (X, \mathscr{T}_2) \) es \textbf{continua} si y solo si \( \mathscr{T}_2 \subseteq \mathscr{T}_1 \). \\ \\
\textbf{\underline{Notacion}:} Si \( \mathscr{T}_2 \subseteq \mathscr{T}_1 \)($\mathscr{T}_1 \subseteq \mathscr{T}_2$), se dice que \( \mathscr{T}_1 \) es \textbf{mas fina} (\textbf{mas gruesa}) que \( \mathscr{T}_2 \). \\ \\
